...
<?php 
    $api_url_topcoder="https://clist.by:443/api/v1/contest//?username=nit1998&api_key=639b0d2d02d6ef8959d6c4f5891feccbd6e2ce65&resource__id__in=12&order_by=-id";
 $contestTopcoder=json_decode(file_get_contents($api_url_topcoder));
 ?>
  <aside id="topcoder">
    <h3 style="color:white;margin:0px auto auto 20px;border-bottom: 2px solid white;">Topcoder
</h3>
<div class="row">
 <?php 
  if(isset($contestTopcoder->objects)){
 foreach ($contestTopcoder->objects as $key){
